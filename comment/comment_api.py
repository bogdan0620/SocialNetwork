...
from database.postservice import get_exact_comment_post_db, add_comment_post_db, change_comment_post_db, delete_comment_post_db
...
def get_exact_post_comments(post_id: int):
    exact_comments = get_exact_comment_post_db(post_id)
